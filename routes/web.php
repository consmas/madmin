...
if (!$is_published) {
    Route::group(['prefix' => 'payment'], function () {
      ...
      Route::group(['prefix' => 'razor-pay', 'as' => 'razor-pay.'], function () {
        ...
        //ROHO CREDIT
        Route::group(['prefix' => 'roho-credit', 'as' => 'roho-credit.'], function () {
            Route::get('pay', [RohoCreditController::class, 'pay'])->name('pay');
            Route::post('webhook', [RohoCreditController::class, 'webhook'])->name('webhook');
        });
